...
All process calculi allow for the following operations:
\begin{itemize}
    \item Communication
...
The null process, generally represented as $0$ or $\emptyset$, does not interact with any other processes. It acts as the terminal process, and is the basis for processes which actually do things.
