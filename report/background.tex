...
Once we have parsed our input and built our syntax tree, we must then semantically analyse the input and generate the processes required. As mentioned before we will be using the Haskell Network module  for our initial implementation.

Here we can demonstrate some basic functionality using Sockets. We can use the Haskell Network module in the following way:
